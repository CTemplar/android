...
public class DeadMansDeliveryDialogFragment extends DialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final TextView dateTextView = view.findViewById(R.id.fragment_dead_mans_dialog_input_date);
        final TextView timeTextView = view.findViewById(R.id.fragment_dead_mans_dialog_input_time);
