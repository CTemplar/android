...
public class DomainsRepository {
    ...
    public Single<CustomDomainDTO> updateCustomDomain(int id, boolean catchAll, String catchAllEmail) {
        return Single.create(emitter -> service.updateCustomDomain(
                id, new UpdateDomainRequest(catchAll, catchAllEmail)
        )
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new SingleObserver<CustomDomainResponse>() {
