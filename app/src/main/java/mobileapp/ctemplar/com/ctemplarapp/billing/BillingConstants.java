...
public class BillingConstants {
    ...
    public static final String MARSHALL_MONTHLY_SKU = "marshall_monthly_subscription";
    ...
    public static final String MARSHALL_ANNUAL_SKU = "marshall_annual_subscription";
