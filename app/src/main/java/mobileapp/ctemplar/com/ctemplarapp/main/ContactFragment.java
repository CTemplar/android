...
import mobileapp.ctemplar.com.ctemplarapp.contact.AddContactActivity;
import mobileapp.ctemplar.com.ctemplarapp.contact.Contact;
import mobileapp.ctemplar.com.ctemplarapp.contact.EditContactActivity;
...
public class ContactFragment extends BaseFragment {
    ...
    private void setupSwiperForRecyclerView() {
        ContactSwiper swipeHandler = new ContactSwiper(getActivity()) {
            @Override
